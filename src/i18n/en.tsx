const en = {
  ...
  "gallery.description1": "Request 5 pictures and pick 1 to entries per day.",
  "gallery.description2": "The exhibited picture can be kept for 7 days.",
  "gallery.description3":
    "If receive likes, The retention time back to 7 days.",
